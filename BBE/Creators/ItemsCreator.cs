    ...
    class ItemsCreator
    {
        ...
        public static void CreateItems()
        {
            ...
            item = new ItemBuilder(BasePlugin.Instance.Info)
                ...
                .SetSmallSprite(AssetsHelper.CreateTexture("Textures", "Items", "BBE_PaintBucketSmall.png").ToSprite(25f))
                .SetLargeSprite(AssetsHelper.CreateTexture("Textures", "Items", "BBE_PaintBucketLarge.png").ToSprite(50f))
                .SetGeneratorCost(80)
                .SetShopPrice(700)
                .SetMeta(ItemFlags.Persists)
                .BuildAndSetup();
            ...
            item = new ItemBuilder(BasePlugin.Instance.Info)
                ...
                .SetSmallSprite(AssetsHelper.CreateTexture("Textures", "Items", "BBE_TimeRewindWristwatchSmall.png").ToSprite(25f))
                .SetLargeSprite(AssetsHelper.CreateTexture("Textures", "Items", "BBE_TimeRewindWristwatchLarge.png").ToSprite(50f))
                .SetGeneratorCost(80)
                .SetShopPrice(800)
                .SetMeta(ItemFlags.Persists)
                .BuildAndSetup();
            ...
            new ItemBuilder(BasePlugin.Instance.Info)
                ...
                .SetSmallSprite(AssetsHelper.CreateTexture("Textures", "Items", "BBE_WeightsSmall.png").ToSprite(25f))
                .SetLargeSprite(AssetsHelper.CreateTexture("Textures", "Items", "BBE_WeightsLarge.png").ToSprite(50f))
                .SetGeneratorCost(0)
                .SetShopPrice()
                .BuildAndSetup();*/
            ...
            new ItemBuilder(BasePlugin.Instance.Info)
                ...
                .SetSmallSprite(AssetsHelper.CreateTexture("Textures", "Items", "BBE_RubyClockSmall.png").ToSprite(25f))
                .SetLargeSprite(AssetsHelper.CreateTexture("Textures", "Items", "BBE_RubyClockLarge.png").ToSprite(50f))
                .SetGeneratorCost(50)
                .SetShopPrice(500)
            ...
            new ItemBuilder(BasePlugin.Instance.Info)
                ...
                .SetSmallSprite(AssetsHelper.CreateTexture("Textures", "Items", "BBE_NoSignSmall.png").ToSprite(25f))
            ...
            item = new ItemBuilder(BasePlugin.Instance.Info)
                ...
                .SetSmallSprite(AssetsHelper.CreateTexture("Textures", "Items", "BBE_RoomTeleporterSmall.png").ToSprite(25f))
                .SetLargeSprite(AssetsHelper.CreateTexture("Textures", "Items", "BBE_RoomTeleporterLarge.png").ToSprite(50f))
            ...
            item = new ItemBuilder(BasePlugin.Instance.Info)
                ...
                .SetSmallSprite(AssetsHelper.CreateTexture("Textures", "Items", "BBE_FlipperZeroSmall.png").ToSprite(25f))
                .SetLargeSprite(AssetsHelper.CreateTexture("Textures", "Items", "BBE_FlipperZeroLarge.png").ToSprite(50f))
            ...
            new ItemBuilder(BasePlugin.Instance.Info)
                ...
                .SetSmallSprite(AssetsHelper.CreateTexture("Textures", "Items", "BBE_DashPadSmall.png").ToSprite(25f))
                .SetLargeSprite(AssetsHelper.CreateTexture("Textures", "Items", "BBE_DashPadLarge.png").ToSprite(50f))
            ...
            new ItemBuilder(BasePlugin.Instance.Info)
                ...
                .SetSmallSprite(AssetsHelper.CreateTexture("Textures", "Items", "BBE_ChessBookSmall.png").ToSprite(25f))
                .SetLargeSprite(AssetsHelper.CreateTexture("Textures", "Items", "BBE_ChessBookLarge.png").ToSprite(50f))
            ...
            item = new ItemBuilder(BasePlugin.Instance.Info)
                ...
                .SetSmallSprite(AssetsHelper.CreateTexture("Textures", "Items", "BBE_MagicCardSmall.png").ToSprite(25f))
                .SetLargeSprite(AssetsHelper.CreateTexture("Textures", "Items", "BBE_MagicCardLarge.png").ToSprite(50f))
                .SetGeneratorCost(300)
                .SetShopPrice(500)
            ...
            item = new ItemBuilder(BasePlugin.Instance.Info)
                ...
                .SetSmallSprite(AssetsHelper.CreateTexture("Textures", "Items", "BBE_BaldiTeleporterSmall.png").ToSprite(25f))
                .SetLargeSprite(AssetsHelper.CreateTexture("Textures", "Items", "BBE_BaldiTeleporterLarge.png").ToSprite(50f))
                .SetGeneratorCost(300)
                .SetShopPrice(500)
                .SetMeta(ItemFlags.CreatesEntity)
                .BuildAndSetup();
